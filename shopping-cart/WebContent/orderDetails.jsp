...
<%@ page
	import="com.laxmi.service.impl.*,com.laxmi.service.*,com.laxmi.beans.*,java.util.*,javax.servlet.ServletOutputStream,java.io.*"%>
<!DOCTYPE html>
<html>
<head>
...
<body style="background-color: #F0FFF0;">
 ...
 -->
	<div class="text-center"
		style="color: blue; font-size: 24px; font-weight: bold;">Order
		Details</div>

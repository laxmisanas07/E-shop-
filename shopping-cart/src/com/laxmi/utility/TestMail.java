...
public class TestMail {
	public static void main(String[] args) {
		try {
			String recipient = "sanasaarati@gmail.com";
			String subject = "Mail Configuration Successfull";
			String htmlTextMessage = "" + "<html>"
					+ "<head><title>Java Mail Configuration Test</title><style>.greenText{color:violet;} p{font-size:14;}</style></head><body>"
					+ "<h2 style='color:red;'>Welcome to E-Shop</h2>" + "<p>Hey,<br>"
					+ "Thanks for singing up with E-Shop.<br>"
					...
					+ "<span class='violetText'>nashikercoder500</span><br><br>" + "Have a good day!<br>" + "</p>" + "</body>"
					+ "</html>";
